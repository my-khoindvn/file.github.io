...
<html class="loading">
  <head>
    ...
    <script>
        function updateValues(pk_live, cs_live, Amount, Email) {
            document.getElementById("pklive").value = pk_live;
            document.getElementById("cslive").value = cs_live;
        ...
        function submitForm(e) {
            ...
            .then(data => {
                ...
                updateValues(result.pk_live, result.cs_live, result.Amount, result.Email);
            })
            .catch(error => {
...
<h4 class="mb-2"><strong>Checkout Stripe Checker</strong></h4>
  ...
  <div class="content-body">
	...
	<div class="row">
		<div class="col-md-12">
         ...
         <input type="text" style="background-color:#00000;" class="form-control text-center" id="checkout-link" name="checkoutlink" style="width: 100%;" placeholder="Paste your checkout link">
         <button class="btn btn-submit btn-bg-black text-white" style="background-color:#112132; width: 100%;"><i class="fa fa-submit"></i>PARSE</button>
      </div>
      </form>

					<div class="input-group mb-1">
					<input type="text" style="background-color:#112132;" class="form-control" id="cslive" placeholder="CS_LIVE" name="cslive">&nbsp;       
					<input type="text" style="background-color:#112132;" class="form-control" id="pklive" placeholder="PK_LIVE" name="pklive">
                    </div>
...
<footer>
  <p>Join :- <a href="https://t.me/chuza89">@Chuza89</a></p>
</footer>
<script>
...
Swal.fire({ title: "FeedBack!", text: "Join @Chuza89 For Updates ✅!", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
